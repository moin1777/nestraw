          ...
          <nav className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-8">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`relative font-medium transition-colors duration-300 text-gray-700 hover:text-navy-900 ${pathname === link.href ? 'font-semibold text-navy-900' : ''}`}
                >
                  {link.label}
                  {pathname === link.href && (
                    <motion.div
            ...
            <div className="hidden lg:flex items-center gap-4">
              <a
                ...
                className="flex items-center gap-2 transition-colors duration-300 text-gray-600 hover:text-navy-900"
              >
                <Phone size={18} />
